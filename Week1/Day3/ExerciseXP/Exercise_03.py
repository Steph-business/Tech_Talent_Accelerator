...
def find_oldest_cat(cat1, cat2, cat3):
    oldest_cat = cats1  # Assume the first cat is the oldest initially
...
print(f"{davids_dog.name} is a {davids_dog.breed} and is {davids_dog.height} cm tall.")
davids_dog.bark()
davids_dog.jump()

print(f"{sarahs_dog.name} is a {sarahs_dog.breed} and is {sarahs_dog.height} cm tall.")
sarahs_dog.bark()
sarahs_dog.jump()
...
# Sort the animals in the zoo  and group 
...
class Circle:
    ...
    def area(self):
        ...
        print(f"Perimeter: {circle1.perimetter()}")

        circle1.definitinion()
